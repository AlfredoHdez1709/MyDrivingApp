...
//1 using Android.Gms.Maps;
//2 using Android.Gms.Maps.Model;
using System;
...
//3 using MyDriving.Droid.Helpers;
...
{
    //TODO: Descomentar lineas 
    public class FragmentCurrentTrip : Android.Support.V4.App.Fragment//1, IOnMapReadyCallback
    {
        /*2
        ...
        */
        ...
        //3public void OnMapReady(GoogleMap googleMap)
        {
            //4map = googleMap;
            if (viewModel != null)
                SetupMap();
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            //5mapView = view.FindViewById<MapView>(Resource.Id.map);
            //6mapView.OnCreate(savedInstanceState);
        ...
        void OnPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            switch (e.PropertyName)
            {
                case nameof(viewModel.CurrentPosition):
                    /*8var latlng = viewModel.CurrentPosition.ToLatLng();
                    UpdateCar(latlng);
                    UpdateCamera(latlng);
                    */break;
        ...
        //10void AddStartMarker(LatLng start)
        void AddStartMarker()
        {
            Activity?.RunOnUiThread(() =>
            {
        ...
        //12void AddEndMarker(LatLng end)
        void AddEndMarker()
        {
            Activity?.RunOnUiThread(() =>
            {
        ...
        void UpdateCarIcon(bool recording)
        {
            Activity?.RunOnUiThread(() =>
            {
                ...
                //15carMarker?.SetIcon(BitmapDescriptorFactory.FromBitmap(finalIcon));
        ...
        //19 void UpdateCar(LatLng latlng)
        void UpdateCar()
        {
            /*20
        ...
        //21 void UpdateCamera(LatLng latlng)
        void UpdateCamera()
        {
            /*22
            if (map == null)
        ...
        public override void OnSaveInstanceState(Bundle outState)
        {
            ...
            //29mapView?.OnSaveInstanceState(outState);
        }

        public override void OnLowMemory()
        {
            base.OnLowMemory();
            //30mapView?.OnLowMemory();
        }
