...
{
    //TODO: Despues de agregar el HubIoT, descomentar 16
    public class OBDDataProcessor
    {
        ...
        public async Task SendTripPointToIOTHub(string tripId, string userId, TripPoint tripDataPoint)
        {
            ...
            if (!CrossConnectivity.Current.IsConnected)
            {
                ...
                //7 Logger.Instance.Track("Unable to push data to IOT Hub - no network connection.");
            ...
            catch (Exception e)
            {
                ...
                //9 Logger.Instance.Track("Unable to send data to IOT Hub: " + e.Message);
